...
@if(have_rows('content'))
    ...
    @if(get_row_layout() == 'section_downloads')

      <?php $sectionFieldData = get_sub_field('section'); ?>

      @include('components.sections.section-col-content-downloads')
    ...
    @if(get_row_layout() == 'section_gallery_grid')

      <?php $sectionFieldData = get_sub_field('section'); ?>

      @include('components.sections.section-gallery-grid')
    ...
    @if(get_row_layout() == 'section_table')

      <?php $sectionFieldData = get_sub_field('section'); ?>

      @include('components.sections.section-table')
