<section  id="header-small" class="header-small section p-t-mobile-section p-b-mobile-section p-t-desktop-section p-b-desktop-section bg-colour-<?php the_sub_field('background_colour');?> text-<?php the_sub_field('text_colour');?>">

  <div class="container-fluid">
    <div class="row">

      <div class="col-lg-4 medium p-t-mobile-section p-b-mobile-section p-b-desktop-none">
