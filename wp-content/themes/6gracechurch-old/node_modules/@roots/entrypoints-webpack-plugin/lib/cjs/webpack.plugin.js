...
exports.EntrypointsWebpackPlugin = void 0;
const helpful_decorators_1 = require("helpful-decorators");
const lodash_1 = require("lodash");
const webpack_1 = require("webpack");
const inline_emitter_1 = require("./inline.emitter");
/**
...
class EntrypointsWebpackPlugin {
    ...
    processAssets() {
        ...
        this.options.emitHtml &&
            new inline_emitter_1.InlineEmitter(this.compilation, this.assets, this.options.publicPath).emitHtmlTags();
        Object.assign(this.compilation.assets, {
            [this.name]: new webpack_1.sources.RawSource(JSON.stringify(this.assets), true),
        });
    }
    /**
...
exports.EntrypointsWebpackPlugin = EntrypointsWebpackPlugin;
