 ...
 * @internal
 */
export declare const isPlugin: (extension: Extension.Constructor) => boolean;
/**
 ...
 * @internal
 */
export declare const hasValidConstructorName: (input: Extension | Extension.Constructor) => boolean;
/**
 ...
 * @internal
 */
export declare const generateName: (input: Extension | Extension.Constructor) => string;
