...
export interface when {
    (test: ((app: Bud) => boolean) | boolean, trueCase: (app: Bud) => any, falseCase?: (app: Bud) => any): Bud;
}
/**
 ...
 * @public
 */
export declare function when(test: ((app: Bud) => boolean) | boolean, trueCase: (app: Bud) => any, falseCase?: (app: Bud) => any): Bud;
