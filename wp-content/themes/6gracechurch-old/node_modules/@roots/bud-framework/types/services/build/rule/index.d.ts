...
export interface Rule {
     ...
     * @public
     */
    setUse<K extends keyof Items & string>(use: ((use: Array<K>, app: Bud) => Array<K>) | Array<K>): Rule;
    /**
     * Use item
     *
     * @public
     ...
     * @public
     */
    setExclude(excludes: ((excludes: Array<string | RegExp | ((app: Bud) => string | RegExp)>) => Array<string | RegExp | ((app: Bud) => string | RegExp)>) | Array<string | RegExp | ((app: Bud) => string | RegExp)>): Rule;
    /**
     * Include paths
     *
     * @public
     ...
     * @public
     */
    setInclude(value: ((includes: Rule['include']) => Rule['include']) | Rule['include']): Rule;
    /**
     * Type
     *
     * @public
     ...
     * @public
     */
    setGenerator(Generator: ((app: Bud) => Rule['generator']) | Rule['generator']): Rule;
    /**
