import { Configuration, MultiCompiler as WebpackMultiCompiler, MultiStats, ProgressPlugin, Stats, StatsCompilation } from 'webpack';
import * as Bud from '../..';
/**
...
export declare type Implementation = (...params: any[]) => any;
export declare type Progress = [number, string];
