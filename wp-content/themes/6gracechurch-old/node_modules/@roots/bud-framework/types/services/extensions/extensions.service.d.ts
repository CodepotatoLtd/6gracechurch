...
export interface Service extends BaseService {
     ...
     * @public
     */
    add(extension: Extension.Constructor | Partial<Extension> | Array<Extension.Constructor | Partial<Extension>>): Promise<unknown>;
    ...
    runAll(methodName: '_init' | '_register' | '_boot' | '_beforeBuild' | '_make'): Promise<Array<void>>;
    run<K extends Modules>(extension: Modules[K & string], methodName: '_init' | '_register' | '_boot' | '_beforeBuild' | '_make'): Promise<this>;
    runDependencies<K extends Modules>(extension: Modules[K & string], methodName: '_init' | '_register' | '_boot' | '_beforeBuild' | '_make'): Promise<void>;
    /**
