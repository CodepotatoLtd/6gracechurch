<section class="section-faq-quote section p-t-mobile-section p-b-mobile-section p-t-desktop-section p-b-desktop-section bg-colour-<?php the_sub_field('background_colour');?> text-<?php the_sub_field('text_colour');?> ">
  <div class="container-fluid">
    <div class="row ">


      <div class="col-lg-4 p-b-mobile-section">
        <div class="medium header p-b-mobile-section p-b-desktop-intro">
        ...
        the_row(); ?>
          ...
          <div class="faq p-b-desktop-element small p-b-mobile-section">
