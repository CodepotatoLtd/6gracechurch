...
<section class="section section-fullscreen-map overflow-hidden text-center bg-colour-<?php echo $sectionData->sectionOptions->bg_colour;?> text-<?php echo $sectionData->sectionOptions->text_colour;?> <?php echo $sectionData->sectionOptions->text_size;?>  padding-top-<?php echo $sectionData->sectionOptions->section_padding_top;?> padding-bottom-<?php echo $sectionData->sectionOptions->section_padding_bottom;?>">
  ...
  <div class="markers-container bg-colour-<?php echo $sectionData->sectionOptions->bg_colour;?> text-center">
    ...
    <h3 class="p marker-type" style="color:<?php echo $colour; ?>" data-type="<?php echo sanitize_title($type);?>"><?php echo $type;?></h3>
